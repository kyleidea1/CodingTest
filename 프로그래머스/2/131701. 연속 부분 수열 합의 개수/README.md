...
### 요약
처음에 이중 반복문으로 단순하게 작성했다가 시간초과가 났다! 1개, 2개, 3개 ... 씩 묶어서 합을 구하면 당연하게도 시간복잡도가 터진다. -> 누적합 이용! dp 느낌으로 시작인덱스로부터의 누적합을 담은 이차원 배열을 사용했다. 시간복잡도 해결~
