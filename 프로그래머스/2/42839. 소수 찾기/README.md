...
### 요약
permutations 를 또 써 보는 연습은 좋았는데, 조금 버벅거렸다!
1. 부분 문자열들의 순열의 합 != 전체 문자열에서 개수를 다르게 구한 순열 : "123"에서 "1","12","123"의 순열의 합과 "123"의 1글자~3글자 순열은 다르다!
2. 문자열 앞의 0 -> 복잡하게 생각할 거 없이 int 씌워 버리면 됨!
