...
### 정리
첫 투 포인터!!
투 포인터는, 이 문제로 기억하면 좋을 것 같다. 핵심은, 투 포인터는 그리디를 구현하는 방법 중 하나이며
가벼운 놈 끼워태우기!!! <- 이렇게 기억하면 된다. 배에 너무 무거운 놈이 탔으면,, 가벼운 놈은 못 들어가지만
조금 덜 무거운 놈이 타면 가벼운 놈들은 조금씩 낄 자리가 생긴다!!
투 포인터가 이런 거였구나~
